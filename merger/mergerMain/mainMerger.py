def main(input):
    approver_list = input["approver_list"]
    Cost_center_data = input["Cost_center_data"]

    if len(approver_list)>=len(Cost_center_data):
        max_list=approver_list
        list2=[{"column13": d["column1"], "column14": d["column2"],"column15": d["column3"], "column16": d["column4"],"column17": d["column5"], "column18": d["column6"],"column19": d["column7"], "column20": d["column8"],"column21": d["column9"], "column22": d["column10"],"column23": d["column11"], "column24": d["column12"],"column25": d["column13"], "column26": d["column14"],"column27": d["column15"], "column28": d["f"]} for d in approver_list2]
    else:
        max_list=Cost_center_data
        list2=[{"column17": d["column1"], "column18": d["column2"],"column19": d["column3"], "column20": d["column4"],"column21": d["column5"], "column22": d["column6"],"column23": d["column7"], "column24": d["column8"],"column25": d["column9"], "column26": d["column10"],"column27": d["column11"], "column28": d["column12"]} for d in approver_list1]
