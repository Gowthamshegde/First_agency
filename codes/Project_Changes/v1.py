    ...
    try:
        for sap_items in sap_input:
            ...
            try:
                ...
                #--------------------------------------Modified project--------pro_lead=person responsible id----
                #1
            ...
            try:
                for items in bamboo_list:
                    ...
                    if items.get(emp_id)==empid or items.get(bamboo_name_id)== empid:
                        ...
                        Employee_Text=items.get(bamboo_name_id)  #these values are not used
            ...
            try:
                for items in bamboo_list:
                    if items.get(emp_id)==empid2 or items.get(bamboo_name_id)== empid:
