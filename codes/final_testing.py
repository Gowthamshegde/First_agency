    ...
    try:
        for sap_items in sap_input:
            converted_input={
                    ...
                    "CC_project_lead":sap_items.get(CC_project_lead),
                    "Cs_LCDT_of_PR_D":sap_items.get(Cs_LCDT_of_PR_D),
                    "Cs_project_lead_ID":sap_items.get(Cs_project_lead_ID),
                    "Cs_previous_person_responsible_ID":sap_items.get(Cs_previous_person_responsible_ID),
                    "Cs_previous_project_lead_ID":sap_items.get(Cs_previous_project_lead_ID),
            ...
            try:
                ...
                failed_reason_list.append( f"${e} while creating Previous_Lead")
                error_list.append(sap_items)
                pass
            ...
            try:
                ...
                failed_co.append(Project_Lead)
            except Exception as e:
                failed_reason_list.append( f"${e} while creating Project_Lead")
                error_list.append(sap_items)
                pass
            ...
            try:
                for items in bamboo_list:
                    # CZ8A3365DF41600F8C
                    if items.get(emp_id)==empid:
                        Bamboo_ID=items.get(bamboo_ID)      #these values are not used
                        Employee_ID=items.get(emp_id)
                        Employee_Text=items.get("TZ8A3365DF41600F8C")  #these values are not used
